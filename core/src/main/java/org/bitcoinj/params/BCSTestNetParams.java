...
public class BCSTestNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public BCSTestNetParams() {
        super();
        interval = INTERVAL;
    ...
    private static BCSTestNetParams instance;
    public static synchronized BCSTestNetParams get() {
        if (instance == null) {
            instance = new BCSTestNetParams();
        }
        return instance;
    }
